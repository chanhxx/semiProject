...
<body>
	...
	<div class="outer">
		...
		<form class="updateForm" action="<%= request.getContextPath() %>/boardSelectUpdate.do" method="post" enctype="multipart/form-data">
	...
	<script>
		...
		$("form").submit(function() {
			...
			// 잘 작성이 되어있으면
				...
				$(this).attr("action", "<%=request.getContextPath()%>/boardSelectUpdate.do");
			}	
		})
